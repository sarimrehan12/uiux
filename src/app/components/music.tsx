...
export default function Music() {
  return (
    ...
    <div className='sm:w-full md:w-[80%] sm:p-5 md:p-5 sm:h-auto md:h-[400px] flex sm:flex-col
     md:flex-row sm:justify-start md:justify-center sm:items-start md:items-center bg-black  '>
        {/*left sec*/}
        <div className='sm:w-full md:w-[50%] p-4'>
          <h3 className='text-green-500 font-bold'>
            Categories</h3>
            <h1 className='text-white font-bold sm:text-md md:text-3xl lg:text-5xl pt-4 '>Enhance Your 

            </h1>
            <h1 className='text-white font-bold sm:text-md md:text-3xl lg:text-5xl pt-4'> Music Experience
            ...
            <button className='bg-green-500 hover:bg-green-500 sm:hidden md:block sm:px-3 md:px-7 sm:text-sm py-0 text-white font-bold rounded-sm h-10 mt-3 '>
                Buy Now
            </button>
            {/*image*/}
